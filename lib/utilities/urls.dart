class Urls {
  ...
  static const register = "${baserUrl}user/register";

  static const sendOtp = "${baserUrl}user/forgot-password";

  static const verifyOtp = "${baserUrl}user/forgot-password/verify-otp";

  static const resetPassword= "${baserUrl}user/reset-password";
