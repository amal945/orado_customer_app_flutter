...
import '../models/active_order_model.dart' show ActiveOrderModel;
...
class HomeProvider extends ChangeNotifier {
  ...
  Future<void> getAllActiveOrder() async {
    final response = await OrderService.getActiveOrder();
  ...
  Future<void> _fetchRecommendedRestaurants(
      String latitude, String longitude) async {
    final response = await HomeService.getRecommendedRestaurant(
  ...
  Future<void> _fetchAllData(String latitude, String longitude,
    ...
    if (categoriesData.isEmpty || forceReload)
      await _fetchCategories(latitude, longitude);
    if (restaurantList.isEmpty || forceReload)
  ...
  Future<void> refresh(BuildContext context) async {
    ...
    try {
      ...
      showSnackBar(context,
          message: "Please check your internet!", backgroundColor: Colors.red);
    } catch (e) {
      showSnackBar(context,
          message: "Some Error Occurred", backgroundColor: Colors.red);
    }
