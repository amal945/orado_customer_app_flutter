      ...
      child: Scaffold(
        ...
        body: Consumer<CartProvider>(
          builder: (
            ...
            final selectedAddress = cartProvider.addresses.firstWhere(
              (address) =>
                  address.addressId == cartProvider.selectedAddressId,
              orElse: () => Addresses(),
            );

            final bool isAddressSelected = selectedAddress.addressId !=
                    null &&
                selectedAddress.addressId == cartProvider.selectedAddressId;
            return CustomUi(
              gap: 0,
              actions: <Widget>[
                Transform.flip(
